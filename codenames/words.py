...
This module contains word lists that can be used in Codenames games.
"""

# Standard word list for Codenames game
WORD_LIST = [
    ...
    "phoenix", "piano", "pie", "pilot", "pin", "pipe", "pirate", "pistol", "pit",
    ...
    "rose", "roulette", "round", "row", "ruler", "satellite", "saturn", "scale",
    "school", "scientist", "scorpion", "screen", "scuba diver", "seal", "server",
...
# Function to get custom word list
def get_custom_word_list(filepath: str) -> list:
    """
    Load a custom word list from a file.
    
    Args:
        filepath: Path to the file containing words (one per line)
    ...
    try:
        ...
        print(f"Error loading custom word list: {e}")
        return WORD_LIST  # Fall back to default word list
